...
class AdminCarrierWizardController extends AdminCarrierWizardControllerCore
{
	...
	public function getStepOneFieldsValues($carrier)
	{
		return array(
			...
			//own code
			'showfromtime' => Configuration::get('dpdbenelux_saturday_showfromtime'),
			'showfromday' => Configuration::get('dpdbenelux_saturday_showfromday'),
			'showtillday' => Configuration::get('dpdbenelux_saturday_showtillday'),
			'showtilltime' => Configuration::get('dpdbenelux_saturday_showtilltime'),
		);
	}
	...
	public function renderStepOne($carrier){
		...
		//own code
		if($carrier->id == $this->DpdCarrier->getLatestCarrierByReferenceId(Configuration::get('dpdbenelux_saturday'))
			|| $carrier->id ==  $this->DpdCarrier->getLatestCarrierByReferenceId(Configuration::get('dpdbenelux_classic_saturday')) ){
	...
	public function ajaxProcessFinishStep()
	{
		...
		// own code
		if($this->DpdCarrier->ifHasSameReferenceId(Tools::getValue('id_carrier'), Configuration::get('dpdbenelux_saturday'))
			|| $this->DpdCarrier->ifHasSameReferenceId(Tools::getValue('id_carrier'), Configuration::get('dpdbenelux_classic_saturday'))  ) {
			if (Tools::getValue('showfromday') === '') {
				...
				Configuration::updateValue('dpdbenelux_saturday_showfromday', Tools::getValue('showfromday'));
				Configuration::updateValue('dpdbenelux_saturday_showfromtime', Tools::getValue('showfromtime'));
				Configuration::updateValue('dpdbenelux_saturday_showtillday', Tools::getValue('showtillday'));
				Configuration::updateValue('dpdbenelux_saturday_showtilltime', Tools::getValue('showtilltime'));
			}
		}
		//prestashops code
