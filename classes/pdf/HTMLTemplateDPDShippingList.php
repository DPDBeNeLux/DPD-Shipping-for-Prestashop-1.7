...
class HTMLTemplateDPDShippingList extends HTMLTemplate
{
	...
	public function assignHookData($object)
	{
		$this->smarty->assign(array(
			...
			'list' => $object,
			'date_now' => $this->date,
			'company_name' => Configuration::get("dpdbenelux_company"),
			'company_street' => Configuration::get("dpdbenelux_street"),
			'company_country' => Configuration::get("dpdbenelux_country"),
			'company_postalcode' => Configuration::get("dpdbenelux_postalcode"),
			'company_place' => Configuration::get("dpdbenelux_place"),
