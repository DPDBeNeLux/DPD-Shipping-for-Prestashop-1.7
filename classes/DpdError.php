...
class DpdError
{
	...
	{
		$this->errors['TO_MANY_PARCELS'] = self::$module->l('Not allowed to have more than 50 parcel\'s', 'dpderror');
		...
		$this->errors['PRINT_LABEL'] = self::$module->l('There went something wrong while printing the label', 'dpderror');
	}
